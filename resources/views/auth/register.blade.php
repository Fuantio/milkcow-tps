                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <select name="type_user" id="type_user" class="form-control @error('type_user') is-invalid @enderror" name="type_user" value="{{ old('type_user') }}" required autocomplete="type_user">>
                        ...
                        <div class="form-group row">
                            <label for="gender" class="col-md-4 col-form-label text-md-right">{{ __('Documento') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="celphone" type="text" class="form-control @error('celphone') is-invalid @enderror" name="celphone" value="{{ old('celphone') }}" required autocomplete="celphone">
